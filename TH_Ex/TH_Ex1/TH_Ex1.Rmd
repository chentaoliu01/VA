...
author:
  - name: Amber Chentao LIU
    url: https://www.linkedin.com/in/amber-chentao-liu/
    affiliation: school of Computation and Information Systems
...
In this hands-on exercise, the [Wine Quality Data Set](https://archive.ics.uci.edu/ml/datasets/wine+quality)
of UCI Machine Learning Repository will be used.  The data set consists of 13 variables and 6497 observations.  For the purpose of this exercise, we have combined the red wine and white wine data into one data file.  It is called wine_quality and is in csv file format.  
