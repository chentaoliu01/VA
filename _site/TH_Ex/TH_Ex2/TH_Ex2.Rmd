...
# Take 0: Fixing erros in Take Home Exercise 1
...
```{r}
pop_subset <-subset(pop_data,PA %in% c("Ang Mo Kio","Bedok","Bishan","Bukit Batok","Bukit Merah", "Bukit Panjang","Bukit Timah", "Clementi","Geylang","Hougang","Jurong East","Jurong West"))
```
...
```
#Version 1.2: Creating an interactive 
